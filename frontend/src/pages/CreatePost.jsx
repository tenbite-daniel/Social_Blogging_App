...
export default function CreatePostPage() {
    ...
    const handleFileChange = (event) => {
        ...
        if (file) {
            setImageUrl("");
            setError(
                "Note: File upload is not yet implemented. Please use an image URL instead."
            );
        }
    };
    ...
    const handlePublish = async () => {
        ...
        try {
            ...
            if (
                imageUrlToSave &&
                (imageUrlToSave.startsWith("C:") ||
                    imageUrlToSave.startsWith("file://"))
            ) {
                setError(
                    "Local file paths are not allowed. Please use a web URL (e.g., https://example.com/image.jpg)"
                );
                return;
            }
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            />
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 transition-colors duration-200">
                                Use a web URL like https://picsum.photos/400/300
                                for a random image
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        style={{
                            borderImage:
                                "linear-gradient(90deg, #36c5d1 0%, #A82ED3 100%) 1",
