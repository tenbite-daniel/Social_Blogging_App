...
const MyPost = () => {
    ...
    return (
        <div className="min-h-screen transition-colors duration-200" 
             style={{ background: 'linear-gradient(to bottom, #FDF7F7, #C6F7F7)' }}>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    {loading ? (
                        ...
                        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                            ...
                            <div className="grid grid-cols-5 gap-4 p-4 text-center font-semibold text-gray-700"
                            ...
                            <div className="divide-y divide-gray-200">
                                {posts.map((post) => (
                                    <div key={post._id} 
                                         className="grid grid-cols-5 gap-4 p-4 items-center bg-white hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <div className="text-center">
                                            <h3 className="font-medium text-gray-900 truncate max-w-xs mx-auto" 
                                                title={post.title}>
                                                {post.title}
                                            </h3>
