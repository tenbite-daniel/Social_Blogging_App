...
export default function About() {
    return (
        <div className="min-h-screen flex flex-col justify-between bg-gradient-to-b from-red-50 to-cyan-50 dark:from-gray-900 dark:to-gray-800 transition-colors duration-200">
            <Header />
            <div>
                <div className="font-martel font-extrabold text-3xl leading-none text-center text-[#36c5d1] dark:text-cyan-300 mt-10 mb-6 transition-colors duration-200 pt-28">
                    About Blog Ease
                </div>
                <div className="max-w-3xl mx-auto font-martel font-normal text-lg leading-[48px] text-center text-[#222] dark:text-gray-200 transition-colors duration-200 px-1">
