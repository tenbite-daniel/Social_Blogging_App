...
const SingleBlogPost = () => {
    ...
    console.log("SingleBlogPost render - State:", {
        loading,
        error,
        post,
        id,
                    ...
                    {comments.length > 0 ? (
                        <div className="space-y-4">
                            {comments.map((comment) => (
                                <div
                                    key={comment._id}
                                    className="border-b border-gray-200 dark:border-gray-600 pb-4 last:border-b-0 transition-colors duration-200"
                                >
