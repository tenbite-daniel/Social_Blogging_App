...
const Footer = () => (
    <footer className="flex flex-col items-center justify-center py-8 bg-cyan-100">
        <div className="font-serif font-bold text-base text-black text-center mb-4">
        ...
        <div className="flex flex-row items-center justify-center gap-4">
            ...
            {socialLinks.map(({ href, label, svg }) => (
                <a
                    ...
                    aria-label={label}
                    className="text-black hover:text-cyan-600 transition-colors duration-200"
                >
                    {svg}
                </a>
            ))}
